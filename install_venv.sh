...
/home/morphs/.pyenv/versions/3.7.3/bin/python3.7 -m pip install install ./wheels/h5py-2.10.0-cp37-cp37m-linux_armv7l.whl
/home/morphs/.pyenv/versions/3.7.3/bin/python3.7 -m pip install install ./wheels/grpcio-1.32.0-cp37-cp37m-linux_armv7l.whl
...
/home/morphs/.pyenv/versions/3.7.3/bin/pipython3.7 -m pip install install ./wheels/tensorflow-2.4.0-cp37-cp37m-linux_armv7l.whl
